...
import com.example.jwt.service.serviceHealth.SleepTargetService;
...
public class SleepTargetController {

    @Autowired
    private JwtHelper jwtHelper;
    @Autowired
    private SleepTargetService sleepTargetService;
    private final UserRepository userRepository;

    public SleepTargetController(UserRepository userRepository) {
    ...
    public ResponseEntity<SleepTarget> setOrUpdateSleepTarget(@RequestHeader("Auth") String tokenHeader,
                                                              @RequestBody SleepTarget sleepTarget) {
        try {
            ...
            sleepTarget = sleepTargetService.SleepTarget(sleepTarget, username);
